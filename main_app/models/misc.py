...
class UserPrivacySetting(models.Model):
    ...
    user = models.ForeignKey(MoveusUser, on_delete=models.CASCADE, related_name='privacy_settings')
...
class UserReport(models.Model):
    reporter = models.ForeignKey(MoveusUser, on_delete=models.CASCADE)
    reported = models.ForeignKey(MoveusUser, on_delete=models.CASCADE, related_name='reported_by')
